...
import { Sheet, SheetContent, SheetDescription, SheetHeader, SheetTitle } from "@/core/presentation/components/base/ui/sheet";
import { Skeleton } from "@/core/presentation/components/base/ui/skeleton";
import { Tooltip, TooltipContent, TooltipTrigger } from "@/core/presentation/components/base/ui/tooltip";
import { PanelLeftIcon } from "lucide-react";
import { TooltipProvider } from "@/core/presentation/components/base/ui/tooltip";
...
function SidebarGroupLabel({ className, asChild = false, ...props }: React.ComponentProps<"div"> & { asChild?: boolean }) {
  ...
  return (
    <Comp
      ...
      className={cn(
        "flex h-8 shrink-0 items-center rounded-md px-2 text-xs font-medium text-sidebar-foreground/70 ring-sidebar-ring outline-hidden transition-[margin,opacity] duration-200 ease-linear group-data-[collapsible=icon]:-mt-8 group-data-[collapsible=icon]:opacity-0 focus-visible:ring-0 [&>svg]:size-4 [&>svg]:shrink-0",
        className
      )}
      {...props}
    />
